...
ibm_vertedero_control_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_control_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_control_rcp85)
...
# Run projections in parallel
ibm_vertedero_canesm5_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_canesm5_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_canesm5_rcp85)
...
# Run projections in parallel
ibm_vertedero_ec_earth3_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_ec_earth3_rcp85,
     file = paste0("Output/Projections/IBM_Natural_", 
              population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_ec_earth3_rcp85)
...
# Run projections in parallel
ibm_vertedero_fgoals_g3_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_fgoals_g3_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_fgoals_g3_rcp85)
...
# Run projections in parallel
ibm_vertedero_gfdl_esm4_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_gfdl_esm4_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_gfdl_esm4_rcp85)
...
# Run projections in parallel
ibm_vertedero_giss_e2_1_g_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_giss_e2_1_g_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_giss_e2_1_g_rcp85)
...
# Run projections in parallel
ibm_vertedero_inm_cm4_8_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_inm_cm4_8_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_inm_cm4_8_rcp85)
...
# Run projections in parallel
ibm_vertedero_ipsl_cm6a_lr_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_ipsl_cm6a_lr_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_ipsl_cm6a_lr_rcp85)
...
# Run projections in parallel
ibm_vertedero_miroc6_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_miroc6_rcp85,
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_miroc6_rcp85)
...
# Run projections in parallel
ibm_vertedero_mpi_esm1_2_lr_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_mpi_esm1_2_lr_rcp85,
     file = paste0("Output/Projections/IBM_Natural_",
              population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_mpi_esm1_2_lr_rcp85)
...
# Run projections in parallel
ibm_vertedero_mri_esm2_0_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_mri_esm2_0_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_mri_esm2_0_rcp85)
...
# Run projections in parallel
ibm_vertedero_noresm2_mm_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_vertedero_noresm2_mm_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_vertedero_noresm2_mm_rcp85)