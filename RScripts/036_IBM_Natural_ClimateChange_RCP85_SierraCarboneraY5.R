...
sfInit(parallel = TRUE, cpus = ncpus, 
       slaveOutfile = paste0("Output/Projections/IBM_Progress_", 
                             population, "_", climate_model, "_RCP85.txt"))
...
ibm_sierracarboneray5_control_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_control_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_control_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_canesm5_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_canesm5_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_canesm5_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_ec_earth3_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_ec_earth3_rcp85,
     file = paste0("Output/Projections/IBM_Natural_", 
              population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_ec_earth3_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_fgoals_g3_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_fgoals_g3_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_fgoals_g3_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_gfdl_esm4_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_gfdl_esm4_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_gfdl_esm4_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_giss_e2_1_g_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_giss_e2_1_g_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_giss_e2_1_g_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_inm_cm4_8_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_inm_cm4_8_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_inm_cm4_8_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_ipsl_cm6a_lr_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_ipsl_cm6a_lr_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_ipsl_cm6a_lr_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_miroc6_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_miroc6_rcp85,
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_miroc6_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_mpi_esm1_2_lr_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_mpi_esm1_2_lr_rcp85,
     file = paste0("Output/Projections/IBM_Natural_",
              population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_mpi_esm1_2_lr_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_mri_esm2_0_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_mri_esm2_0_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_mri_esm2_0_rcp85)
...
# Run projections in parallel
ibm_sierracarboneray5_noresm2_mm_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_noresm2_mm_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierracarboneray5_noresm2_mm_rcp85)
