...
ibm_sierraretiny5_control_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_control_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_control_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_canesm5_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_canesm5_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_canesm5_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_ec_earth3_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_ec_earth3_rcp85,
     file = paste0("Output/Projections/IBM_Natural_", 
              population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_ec_earth3_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_fgoals_g3_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_fgoals_g3_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_fgoals_g3_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_gfdl_esm4_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_gfdl_esm4_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_gfdl_esm4_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_giss_e2_1_g_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_giss_e2_1_g_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_giss_e2_1_g_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_inm_cm4_8_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_inm_cm4_8_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_inm_cm4_8_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_ipsl_cm6a_lr_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_ipsl_cm6a_lr_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_ipsl_cm6a_lr_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_miroc6_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_miroc6_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_miroc6_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_mpi_esm1_2_lr_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_mpi_esm1_2_lr_rcp85,
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_mpi_esm1_2_lr_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_mri_esm2_0_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_mri_esm2_0_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_mri_esm2_0_rcp85)
...
# Run projections in parallel
ibm_sierraretiny5_noresm2_mm_rcp85 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierraretiny5_noresm2_mm_rcp85, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_sierraretiny5_noresm2_mm_rcp85)
