...
ibm_monteratorero_control = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_control, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_control)
...
# Run projections in parallel
ibm_monteratorero_canesm5 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_canesm5, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_canesm5)
...
# Run projections in parallel
ibm_monteratorero_ec_earth3 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_ec_earth3,
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_ec_earth3)
...
# Run projections in parallel
ibm_monteratorero_fgoals_g3 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_fgoals_g3, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_fgoals_g3)
...
# Run projections in parallel
ibm_monteratorero_gfdl_esm4 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_gfdl_esm4, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_gfdl_esm4)
...
# Run projections in parallel
ibm_monteratorero_giss_e2_1_g = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_giss_e2_1_g, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_giss_e2_1_g)
...
# Run projections in parallel
ibm_monteratorero_inm_cm4_8 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_inm_cm4_8, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_inm_cm4_8)
...
# Run projections in parallel
ibm_monteratorero_ipsl_cm6a_lr = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_ipsl_cm6a_lr, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_ipsl_cm6a_lr)
...
# Run projections in parallel
ibm_monteratorero_miroc6 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_miroc6, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_miroc6)
...
# Run projections in parallel
ibm_monteratorero_mpi_esm1_2_lr = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_mpi_esm1_2_lr, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_mpi_esm1_2_lr)
...
# Run projections in parallel
ibm_monteratorero_mri_esm2_0 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_mri_esm2_0, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_mri_esm2_0)
...
# Run projections in parallel
ibm_monteratorero_noresm2_mm = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_monteratorero_noresm2_mm, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_monteratorero_noresm2_mm)