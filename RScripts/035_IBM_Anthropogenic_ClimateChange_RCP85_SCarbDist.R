...
ibm_scarbdist_control_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_control_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_control_rcp85)
...
# Run projections in parallel
ibm_scarbdist_canesm5_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_canesm5_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_canesm5_rcp85)
...
# Run projections in parallel
ibm_scarbdist_ec_earth3_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_ec_earth3_rcp85,
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_ec_earth3_rcp85)
...
# Run projections in parallel
ibm_scarbdist_fgoals_g3_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_fgoals_g3_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_fgoals_g3_rcp85)
...
# Run projections in parallel
ibm_scarbdist_gfdl_esm4_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_gfdl_esm4_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_gfdl_esm4_rcp85)
...
# Run projections in parallel
ibm_scarbdist_giss_e2_1_g_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_giss_e2_1_g_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_giss_e2_1_g_rcp85)
...
# Run projections in parallel
ibm_scarbdist_inm_cm4_8_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_inm_cm4_8_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_inm_cm4_8_rcp85)
...
# Run projections in parallel
ibm_scarbdist_ipsl_cm6a_lr_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_ipsl_cm6a_lr_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_ipsl_cm6a_lr_rcp85)
...
# Run projections in parallel
ibm_scarbdist_miroc6_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_miroc6_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_miroc6_rcp85)
...
# Run projections in parallel
ibm_scarbdist_mpi_esm1_2_lr_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_mpi_esm1_2_lr_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_mpi_esm1_2_lr_rcp85)
...
# Run projections in parallel
ibm_scarbdist_mri_esm2_0_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_mri_esm2_0_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_mri_esm2_0_rcp85)
...
# Run projections in parallel
ibm_scarbdist_noresm2_mm_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_scarbdist_noresm2_mm_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_scarbdist_noresm2_mm_rcp85)
