...
ibm_prisoneros_control_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_control_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_control_rcp45)
...
# Run projections in parallel
ibm_prisoneros_canesm5_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_canesm5_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_canesm5_rcp45)
...
# Run projections in parallel
ibm_prisoneros_ec_earth3_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_ec_earth3_rcp45,
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_ec_earth3_rcp45)
...
# Run projections in parallel
ibm_prisoneros_fgoals_g3_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_fgoals_g3_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_fgoals_g3_rcp45)
...
# Run projections in parallel
ibm_prisoneros_gfdl_esm4_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_gfdl_esm4_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_gfdl_esm4_rcp45)
...
# Run projections in parallel
ibm_prisoneros_giss_e2_1_g_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_giss_e2_1_g_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_giss_e2_1_g_rcp45)
...
# Run projections in parallel
ibm_prisoneros_inm_cm4_8_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_inm_cm4_8_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_inm_cm4_8_rcp45)
...
# Run projections in parallel
ibm_prisoneros_ipsl_cm6a_lr_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_ipsl_cm6a_lr_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_ipsl_cm6a_lr_rcp45)
...
# Run projections in parallel
ibm_prisoneros_miroc6_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_miroc6_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_miroc6_rcp45)
...
# Run projections in parallel
ibm_prisoneros_mpi_esm1_2_lr_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_mpi_esm1_2_lr_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_mpi_esm1_2_lr_rcp45)
...
# Run projections in parallel
ibm_prisoneros_mri_esm2_0_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_mri_esm2_0_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_mri_esm2_0_rcp45)
...
# Run projections in parallel
ibm_prisoneros_noresm2_mm_rcp45 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisoneros_noresm2_mm_rcp45, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_prisoneros_noresm2_mm_rcp45)
