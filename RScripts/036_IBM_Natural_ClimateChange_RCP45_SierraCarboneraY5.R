...
CanESM5_climate = read.csv("Data/CanESM5_MonthlyClimateProjection_RCP45.csv")
EC_Earth3_climate = read.csv("Data/EC_Earth3_MonthlyClimateProjection_RCP45.csv")
FGOALS_G3_climate = read.csv("Data/FGOALS_G3_MonthlyClimateProjection_RCP45.csv")
GFDL_ESM4_climate = read.csv("Data/GFDL_ESM4_MonthlyClimateProjection_RCP45.csv")
GISS_E2_1_G_climate = read.csv("Data/GISS_E2_1_G_MonthlyClimateProjection_RCP45.csv")
INM_CM4_8_climate = read.csv("Data/INM_CM4_8_MonthlyClimateProjection_RCP45.csv")
IPSL_CM6A_LR_climate = read.csv("Data/IPSL_CM6A_LR_MonthlyClimateProjection_RCP45.csv")
MIROC6_climate = read.csv("Data/MIROC6_MonthlyClimateProjection_RCP45.csv")
MPI_ESM1_2_LR_climate = read.csv("Data/MPI_ESM1_2_LR_MonthlyClimateProjection_RCP45.csv")
MRI_ESM2_0_climate = read.csv("Data/MRI_ESM2_0_MonthlyClimateProjection_RCP45.csv")
NorESM2_MM_climate = read.csv("Data/NorESM2_MM_MonthlyClimateProjection_RCP45.csv")
...
ibm_sim = function(n_sim,              # Number of simulations
  ...
  for(i in 2:n_years){
    ...
    if(climate_model == "Control"){
      ...
      summerT = unique(droso_natural$summerT_unscaled[which(droso_natural$site == population &
                                                            droso_natural$time == year)])
      prevwinterT = unique(droso_natural$prevwinterT_unscaled[which(droso_natural$site == population &
                                                                    droso_natural$time == year)])
      
      fallR = unique(droso_natural$fallR_unscaled[which(droso_natural$site == population &
                                                        droso_natural$time == year)])
      prevfallR = unique(droso_natural$prevfallR_unscaled[which(droso_natural$site == population &
                                                                droso_natural$time == year)])
    }
...
sfInit(parallel = TRUE, cpus = ncpus, 
       slaveOutfile = paste0("Output/Projections/IBM_Progress_", 
                             population, "_", climate_model, "_RCP45.txt"))
...
ibm_sierracarboneray5_control_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_control_rcp45, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_control_rcp45)
...
# Run projections in parallel
ibm_sierracarboneray5_canesm5_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_canesm5_rcp45, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_canesm5_rcp45)
...
# Run projections in parallel
ibm_sierracarboneray5_ec_earth3_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_ec_earth3_rcp45,
     file = paste0("Output/Projections/IBM_Natural_", 
              population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_ec_earth3_rcp45)
...
# Run projections in parallel
ibm_sierracarboneray5_fgoals_g3_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_fgoals_g3_rcp45, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_fgoals_g3_rcp45)
...
# Run projections in parallel
ibm_sierracarboneray5_gfdl_esm4_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_gfdl_esm4_rcp45, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_gfdl_esm4_rcp45)
...
# Run projections in parallel
ibm_sierracarboneray5_giss_e2_1_g_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_giss_e2_1_g_rcp45, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_giss_e2_1_g_rcp45)
...
# Run projections in parallel
ibm_sierracarboneray5_inm_cm4_8_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_inm_cm4_8_rcp45, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_inm_cm4_8_rcp45)
...
# Run projections in parallel
ibm_sierracarboneray5_ipsl_cm6a_lr_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_ipsl_cm6a_lr_rcp45, 
     file = paste0("Output/Projections/IBM_Natural_",
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_ipsl_cm6a_lr_rcp45)
...
# Run projections in parallel
ibm_sierracarboneray5_miroc6_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_miroc6_rcp45,
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_miroc6_rcp45)


## 6.1.10. MPI_ESM1_2_LR ----
# ----------------------
...
# Run projections in parallel
ibm_sierracarboneray5_mpi_esm1_2_lr_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_mpi_esm1_2_lr_rcp45,
     file = paste0("Output/Projections/IBM_Natural_",
              population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_mpi_esm1_2_lr_rcp45)
...
# Run projections in parallel
ibm_sierracarboneray5_mri_esm2_0_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_mri_esm2_0_rcp45, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_mri_esm2_0_rcp45)
...
# Run projections in parallel
ibm_sierracarboneray5_noresm2_mm_rcp45 <- sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_sierracarboneray5_noresm2_mm_rcp45, 
     file = paste0("Output/Projections/IBM_Natural_", 
                   population, "_", climate_model, "_RCP45.RData"))
sfStop()

rm(ibm_sierracarboneray5_noresm2_mm_rcp45)
