...
# Run projections in parallel
ibm_bujeo_canesm5_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_canesm5_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_canesm5_rcp85)
...
# Run projections in parallel
ibm_bujeo_ec_earth3_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_ec_earth3_rcp85,
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_ec_earth3_rcp85)
...
# Run projections in parallel
ibm_bujeo_fgoals_g3_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_fgoals_g3_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_fgoals_g3_rcp85)
...
# Run projections in parallel
ibm_bujeo_gfdl_esm4_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_gfdl_esm4_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_gfdl_esm4_rcp85)
...
# Run projections in parallel
ibm_bujeo_giss_e2_1_g_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_giss_e2_1_g_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_giss_e2_1_g_rcp85)
...
# Run projections in parallel
ibm_bujeo_inm_cm4_8_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_inm_cm4_8_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_inm_cm4_8_rcp85)
...
# Run projections in parallel
ibm_bujeo_ipsl_cm6a_lr_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_ipsl_cm6a_lr_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_ipsl_cm6a_lr_rcp85)
...
# Run projections in parallel
ibm_bujeo_miroc6_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_miroc6_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_miroc6_rcp85)
...
# Run projections in parallel
ibm_bujeo_mpi_esm1_2_lr_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_mpi_esm1_2_lr_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_mpi_esm1_2_lr_rcp85)
...
# Run projections in parallel
ibm_bujeo_mri_esm2_0_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_mri_esm2_0_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_mri_esm2_0_rcp85)
...
# Run projections in parallel
ibm_bujeo_noresm2_mm_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_noresm2_mm_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_bujeo_noresm2_mm_rcp85)