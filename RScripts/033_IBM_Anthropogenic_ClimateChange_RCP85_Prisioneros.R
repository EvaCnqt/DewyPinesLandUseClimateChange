...
ibm_prisioneros_control_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_control_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_control_rcp85)
...
# Run projections in parallel
ibm_prisioneros_canesm5_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_canesm5_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_canesm5_rcp85)
...
# Run projections in parallel
ibm_prisioneros_ec_earth3_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_ec_earth3_rcp85,
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_ec_earth3_rcp85)
...
# Run projections in parallel
ibm_prisioneros_fgoals_g3_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_fgoals_g3_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_fgoals_g3_rcp85)
...
# Run projections in parallel
ibm_prisioneros_gfdl_esm4_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_gfdl_esm4_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_gfdl_esm4_rcp85)
...
# Run projections in parallel
ibm_prisioneros_giss_e2_1_g_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_giss_e2_1_g_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_giss_e2_1_g_rcp85)
...
# Run projections in parallel
ibm_prisioneros_inm_cm4_8_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_inm_cm4_8_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_inm_cm4_8_rcp85)
...
# Run projections in parallel
ibm_prisioneros_ipsl_cm6a_lr_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_ipsl_cm6a_lr_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_ipsl_cm6a_lr_rcp85)
...
# Run projections in parallel
ibm_prisioneros_miroc6_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_miroc6_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_miroc6_rcp85)
...
# Run projections in parallel
ibm_prisioneros_mpi_esm1_2_lr_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_mpi_esm1_2_lr_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_mpi_esm1_2_lr_rcp85)
...
# Run projections in parallel
ibm_prisioneros_mri_esm2_0_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_mri_esm2_0_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_mri_esm2_0_rcp85)
...
# Run projections in parallel
ibm_prisioneros_noresm2_mm_rcp85 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_prisioneros_noresm2_mm_rcp85, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, "_RCP85.RData"))
sfStop()

rm(ibm_prisioneros_noresm2_mm_rcp85)
