...
ibm_retin_canesm5_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_canesm5_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_canesm5_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_canesm5_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_canesm5_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_canesm5_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_canesm5_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_canesm5_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_canesm5_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_canesm5_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_canesm5_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_canesm5_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_canesm5_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_canesm5_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_canesm5_sensitivity_seedlingSize)
...
# Run projections in parallel
ibm_retin_ec_earth3_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_ec_earth3_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_ec_earth3_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_ec_earth3_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_ec_earth3_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_ec_earth3_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_ec_earth3_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_ec_earth3_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_ec_earth3_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_ec_earth3_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_ec_earth3_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_ec_earth3_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_ec_earth3_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_ec_earth3_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_ec_earth3_sensitivity_seedlingSize)
...
# Run projections in parallel
ibm_retin_fgoals_g3_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_fgoals_g3_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_fgoals_g3_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_fgoals_g3_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_fgoals_g3_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_fgoals_g3_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_fgoals_g3_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_fgoals_g3_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_fgoals_g3_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_fgoals_g3_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_fgoals_g3_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_fgoals_g3_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_fgoals_g3_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_fgoals_g3_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_fgoals_g3_sensitivity_seedlingSize)
...
# Run projections in parallel
ibm_retin_gfdl_esm4_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_gfdl_esm4_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_gfdl_esm4_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_gfdl_esm4_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_gfdl_esm4_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_gfdl_esm4_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_gfdl_esm4_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_gfdl_esm4_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_gfdl_esm4_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_gfdl_esm4_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_gfdl_esm4_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_gfdl_esm4_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_gfdl_esm4_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_gfdl_esm4_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_gfdl_esm4_sensitivity_seedlingSize)
...
# Run projections in parallel
ibm_retin_giss_e2_1_g_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_giss_e2_1_g_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_giss_e2_1_g_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_giss_e2_1_g_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_giss_e2_1_g_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_giss_e2_1_g_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_giss_e2_1_g_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_giss_e2_1_g_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_giss_e2_1_g_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_giss_e2_1_g_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_giss_e2_1_g_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_giss_e2_1_g_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_giss_e2_1_g_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_giss_e2_1_g_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_giss_e2_1_g_sensitivity_seedlingSize)
...
# Run projections in parallel
ibm_retin_inm_cm4_8_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_inm_cm4_8_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_inm_cm4_8_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_inm_cm4_8_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_inm_cm4_8_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_inm_cm4_8_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_inm_cm4_8_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_inm_cm4_8_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_inm_cm4_8_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_inm_cm4_8_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_inm_cm4_8_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_inm_cm4_8_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_inm_cm4_8_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_inm_cm4_8_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_inm_cm4_8_sensitivity_seedlingSize)
...
# Run projections in parallel
ibm_retin_ipsl_cm6a_lr_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_ipsl_cm6a_lr_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_ipsl_cm6a_lr_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_ipsl_cm6a_lr_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_ipsl_cm6a_lr_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_ipsl_cm6a_lr_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_ipsl_cm6a_lr_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_ipsl_cm6a_lr_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_ipsl_cm6a_lr_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_ipsl_cm6a_lr_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_ipsl_cm6a_lr_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_ipsl_cm6a_lr_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_ipsl_cm6a_lr_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_ipsl_cm6a_lr_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_ipsl_cm6a_lr_sensitivity_seedlingSize)
...
# Run projections in parallel
ibm_retin_miroc6_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_miroc6_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_miroc6_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_miroc6_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_miroc6_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_miroc6_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_miroc6_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_miroc6_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_miroc6_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_miroc6_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_miroc6_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_miroc6_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_miroc6_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_miroc6_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_miroc6_sensitivity_seedlingSize)
...
# Run projections in parallel
ibm_retin_mpi_esm1_2_lr_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_mpi_esm1_2_lr_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_mpi_esm1_2_lr_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_mpi_esm1_2_lr_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_mpi_esm1_2_lr_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_mpi_esm1_2_lr_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_mpi_esm1_2_lr_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_mpi_esm1_2_lr_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_mpi_esm1_2_lr_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_mpi_esm1_2_lr_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_mpi_esm1_2_lr_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_mpi_esm1_2_lr_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_mpi_esm1_2_lr_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_mpi_esm1_2_lr_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_mpi_esm1_2_lr_sensitivity_seedlingSize)
...
# Run projections in parallel
ibm_retin_mri_esm2_0_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_mri_esm2_0_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_mri_esm2_0_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_mri_esm2_0_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_mri_esm2_0_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_mri_esm2_0_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_mri_esm2_0_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_mri_esm2_0_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_mri_esm2_0_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_mri_esm2_0_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_mri_esm2_0_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_mri_esm2_0_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_mri_esm2_0_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_mri_esm2_0_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_mri_esm2_0_sensitivity_seedlingSize)
...
# Run projections in parallel
ibm_retin_noresm2_mm_sensitivity_survival = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_noresm2_mm_sensitivity_survival, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_noresm2_mm_sensitivity_survival)
...
# Run projections in parallel
ibm_retin_noresm2_mm_sensitivity_growth = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_noresm2_mm_sensitivity_growth, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_noresm2_mm_sensitivity_growth)
...
# Run projections in parallel
ibm_retin_noresm2_mm_sensitivity_flowering = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_noresm2_mm_sensitivity_flowering, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_noresm2_mm_sensitivity_flowering)
...
# Run projections in parallel
ibm_retin_noresm2_mm_sensitivity_nbFlowers = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_noresm2_mm_sensitivity_nbFlowers, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_noresm2_mm_sensitivity_nbFlowers)
...
# Run projections in parallel
ibm_retin_noresm2_mm_sensitivity_seedlingSize = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_retin_noresm2_mm_sensitivity_seedlingSize, 
     file = paste0("Output/Projections/IBM_Anthropogenic_SensitivityAnalysis_", 
                   population, "_", climate_model, "_", 
                   vital_rate, ".RData"))
sfStop()

rm(ibm_retin_noresm2_mm_sensitivity_seedlingSize)
