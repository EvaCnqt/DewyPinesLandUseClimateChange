...
# Run projections in parallel
ibm_bujeo_canesm5 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_canesm5, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_bujeo_canesm5)
...
# Run projections in parallel
ibm_bujeo_ec_earth3 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_ec_earth3,
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_bujeo_ec_earth3)
...
# Run projections in parallel
ibm_bujeo_fgoals_g3 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_fgoals_g3, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_bujeo_fgoals_g3)
...
# Run projections in parallel
ibm_bujeo_gfdl_esm4 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_gfdl_esm4, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_bujeo_gfdl_esm4)
...
# Run projections in parallel
ibm_bujeo_giss_e2_1_g = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_giss_e2_1_g, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_bujeo_giss_e2_1_g)
...
# Run projections in parallel
ibm_bujeo_inm_cm4_8 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_inm_cm4_8, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_bujeo_inm_cm4_8)
...
# Run projections in parallel
ibm_bujeo_ipsl_cm6a_lr = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_ipsl_cm6a_lr, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_bujeo_ipsl_cm6a_lr)
...
# Run projections in parallel
ibm_bujeo_miroc6 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_miroc6, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()
...
# Run projections in parallel
ibm_bujeo_mpi_esm1_2_lr = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_mpi_esm1_2_lr, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_bujeo_mpi_esm1_2_lr)
...
# Run projections in parallel
ibm_bujeo_mri_esm2_0 = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_mri_esm2_0, 
     file = paste0("Output/Projections/IBM_Anthropogenic_",
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_bujeo_mri_esm2_0)
...
# Run projections in parallel
ibm_bujeo_noresm2_mm = sfClusterApplyLB(1:ncpus, startIBM)

# Save results and stop cluster
save(ibm_bujeo_noresm2_mm, 
     file = paste0("Output/Projections/IBM_Anthropogenic_", 
                   population, "_", climate_model, ".RData"))
sfStop()

rm(ibm_bujeo_noresm2_mm)